---
title: "The Chokepoints Inside Europe"
date: "2026-07-21"
excerpt: "As the Rhine and Danube fall, Europe is discovering that landing energy at its ports is not the same as delivering it. A river does not have to close to become a chokepoint — it only has to grow too shallow to carry what Europe expects of it."
author: "Jon Kelly"
---
...
> **Update — 31 July 2026 (Reuters).** The internal chokepoint has now reached the power system. Hungary's Paks nuclear plant — source of nearly half the country's electricity — shuts on Monday, possibly for weeks, because the Danube is too low to cool it safely; Romania's Nuclearelectrica has shut one of its two reactors with the second expected to follow, potentially a fifth of national needs; and France has reduced nuclear output on low, warm rivers. Serbia's Djerdap 1, its largest hydro plant, is running at **20% of capacity**, and low water has cut its Kostolac coal units too — Belgrade and Budapest are buying replacement power on an expensive spot market. Freight is tightening in step: cargo between Rotterdam and the Rhine has fallen every week since early July to about **10% below normal**, with oil-product and chemical tankers hit hardest because they sit deepest, and Danube grain barges can now only reach ports near the Black Sea. The bill is appearing in accounts — Verbund puts the first-half drought cost at about €370m, EDF has cut its 2026 earnings outlook by ~10%, A2A expects 3.9 TWh of hydro against a 4.1 average — and Kpler's Alessandro Armenia summarises the trajectory: “either we're going to see blackouts or we need to invest way more.” The cascade runs straight into the fuels this site tracks: lost hydro and nuclear is replaced by gas Europe is struggling to store, and lost barge capacity moves to trucks burning the diesel Europe is shortest of.
...
*This is a worked application of the framework set out in [Why Cheap Energy Isn't Always Cheap](/analysis/why-cheap-energy-isnt-always-cheap), and it shares its logic with [Bypassing a Chokepoint 135 Barrels at a Time](/analysis/bypassing-a-chokepoint-135-barrels-at-a-time): a route's nominal existence says nothing about the capacity actually moving through it. There, the chokepoint was maritime; here, it is inland.*
