        ...
        <div className="overflow-x-auto rounded-lg border border-oil-800 mt-4">
          <table className="w-full text-left">
            ...
            <tbody>
              ...
              <SourceRow scope="Germany — granular detail" source="tankerkoenig.de (MTS-K)" flag="planned" granularity="Architecture ready; pending tankerkoenig API key approval. ~16,000 stations once live." />
              <SourceRow scope="Spain — granular detail" source="Geoportal de Hidrocarburos" flag="live" granularity="Station-level → provincia + CCAA rollups (daily)" />
              <SourceRow scope="Italy — granular detail" source="MIMIT carburanti datasets" flag="live" granularity="Station-level → provincia + regione rollups (daily)" />
