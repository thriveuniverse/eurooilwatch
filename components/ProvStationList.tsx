              ...
              <table className="w-full text-left text-sm">
                <thead className="bg-oil-900/50">
                  <tr>
                    ...
                    <th className="px-3 py-2 text-[10px] font-mono uppercase tracking-wider text-amber-400/80 text-right">Gasóleo</th>
                    <th className="px-3 py-2 text-[10px] font-mono uppercase tracking-wider text-amber-400/80 text-right">Gasolina 95</th>
                    <th className="px-3 py-2 text-[10px] font-mono uppercase tracking-wider text-amber-400/80 text-right">Gasolina 98</th>
                  </tr>
                </thead>
                <tbody>
